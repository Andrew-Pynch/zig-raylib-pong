...
pub fn main() void {
    ...
    while (!c.WindowShouldClose()) // Detect window close button or ESC key
    {
        ...
        if (collision) {
            ...
            // Draw collision area
            c.DrawText(c.TextFormat("Collision Area: %i", @as(c_int, @intFromFloat(box_collision.width)) * @as(c_int, @intFromFloat(box_collision.height))), @divTrunc(c.GetScreenWidth(), 2) - 100, screen_upper_limit + 10, 20, c.BLACK);
        }
